...
-- Schéma initial
SOURCE C:/www/STUDI/EXAMEN/ECF/ViteEtGourmand/database/schemas/001_utilisateur.sql;
...
-- Seed initial
SOURCE C:/www/STUDI/EXAMEN/ECF/ViteEtGourmand/database/seeds/001_utilisateur.sql;
