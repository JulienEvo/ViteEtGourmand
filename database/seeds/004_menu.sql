...
/*** MENUS ***/
INSERT INTO menu (titre, description, conditions, min_personne, tarif_personne, quantite, actif)
VALUES ('Végétarien', 'Végétarien', 'Conditions : à conserver au frais', '2', '30', '10', '1');
